...
def randBuildLSB():
    ...
    ua = f"Dalvik/2.1.0 (Linux; U; Android 7.1.1; Moto G5 Plus Build/NPNS25.137-92-14) [FBAN/Orca-Android;FBAV/291.0.0.16.118;FBPN/com.facebook.orca;FBLC/it_IT;FBBV/256789123;FBCR/Vodafone;FBMF/motorola;FBBD/motorola;FBDV/Moto G5 Plus;FBSV/7.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1080,height=1920};FB_FW/1;]"+END
    return ua
